...
<!-- one target approach (from decisions.md), 2-3 sentences. Preserving and formalizing a coherent current/domain-native structure is valid; a named paradigm is optional. -->
...
## Rules for new implementation and artifacts
<!-- new source/config/infrastructure/docs artifacts follow the target structure; don't fix old mismatches in passing—record them in [[legacy_warning]] / [[migration_backlog]] -->
